...
MBOOT_LINUX_PATCH_DIR = $(BR2_EXTERNAL_MBOOT_PATH)/board/mboot/patches/linux

define MBOOT_LINUX_APPLY_MBOOT_PATCHES
	$(APPLY_PATCHES) $(@D) $(MBOOT_LINUX_PATCH_DIR) \*.patch
endef
LINUX_POST_PATCH_HOOKS += MBOOT_LINUX_APPLY_MBOOT_PATCHES
